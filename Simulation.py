...
canvas(width=1500, height=1000)  # slightly bigger than default, adjust if you have small screen.
...
graphpos=graph(x=2000,y=2000,width=1000,height=500,title='Position Vs Time', xtitle='time',ytitle='Position',foreground=color.black, background=color.black)
graphVel=graph(x=2000,y=2000,width=1000,height=500,title='Velocity Vs Time', xtitle='time',ytitle='Velocity',foreground=color.black, background=color.black)
